-- There are two sections of this file. First part
-- is a copy of the BA mod and the second is the
-- Damage Deal's special options.
--
-- TODO: Make this script dynamically so it loads the BA options and just adds them to the DamageDeal's modOptions
